...
* The next word prediction app is hosted on shinyapps.io: [https://mehtashubham.shinyapps.io/next_word_predictor](https://mehtashubham.shinyapps.io/next_word_predictor)

* The whole code of this application, as well as all the milestone report, related scripts, this presentation  etc. can be found in this GitHub repo: [https://github.com/mehtashubham/Data-science-capstone.git](https://github.com/mehtashubham/Data-science-capstone.git)

* This pitch deck is located here: [http://rpubs.com/mehtashubham/249087](http://rpubs.com/mehtashubham/249087)
